...
func testpairG2neg_useneg(t *testing.T, useneg bool) {
	suite := NewSuite()
...
// 3.0.11)
func testpairG1neg_useneg(t *testing.T, useneg bool) {
	suite := NewSuite()
	g1 := suite.G1().Point().Base()
	g2 := suite.G2().Point().Base()
...
func TestPairG2Mul(t *testing.T) {
	testpairG2neg_useneg(t, false)
}

func TestPairG2Neg(t *testing.T) {
	testpairG2neg_useneg(t, true)
}

func TestPairG1Mul(t *testing.T) {
	testpairG1neg_useneg(t, false)
}

func TestPairG1Neg(t *testing.T) {
	testpairG1neg_useneg(t, true)
}
